...
public class JackpotGoldWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(JackpotGoldWLAEngineManagerTest.class);
		logger.setLevel(Level.DEBUG);
		gameParams = XMLUtil.parseResource("paymodel/JackpotGoldWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/JackpotGoldWLAIW/InitOutcome.xml").getDocumentElement();
